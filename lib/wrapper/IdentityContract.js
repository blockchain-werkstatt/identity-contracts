...
var IdentityContract = function () {
  ...
  _createClass(IdentityContract, [{
    ...
    value: function createInstanceIdentityContract(address) {
      this.identityContract = this.lightWallet.createContractInstance({
        address: address,
    ...
    value: function addVerificationToTargetIdentity(_ref) {
      ...
      return this.lightWallet.contractMethodTransaction(this.identityContract, methodName, args, pin);
    }
  }, {
    ...
    value: function addAttributeHashAndWait(_ref4) {
      var _this = this;

      var attributeId = _ref4.attributeId,
          attribute = _ref4.attribute,
          definitionUrl = _ref4.definitionUrl,
          pin = _ref4.pin;

      return this.addAttributeHashToIdentity(attributeId, attribute, definitionUrl, pin, this.getIdentityAddress()).then(function (transactionHash) {
    ...
    value: function getAttributeHash(_ref5) {
    ...
    key: 'getVerification',
    value: function getVerification(_ref6) {
      var attributeId = _ref6.attributeId,
          verificationIdx = _ref6.verificationIdx,
    ...
    value: function getAttributeHashCreator(_ref7) {
    ...
    value: function getNumberOfVerifications(_ref8) {
      var attributeId = _ref8.attributeId,
          identityAddress = _ref8.identityAddress;
    ...
    value: function createDigitalIdentity(_ref9) {
      var pin = _ref9.pin;
    ...
    value: function getProperty(propertyId) {
      ...
      return new Promise(function (resolve, reject) {
        _this3.identityContract.properties(id, function (err, result) {
          if (err) {
            throw err;
          }
    ...
    value: function killIdentityContract(_ref10) {
      var identityContractAddress = _ref10.identityContractAddress,
          pin = _ref10.pin;
    ...
    key: 'addProperty',
    value: function addProperty(_ref11) {
      var id = _ref11.id,
          value = _ref11.value,
          pin = _ref11.pin;
    ...
    value: function addPropertyToTarget(_ref12) {
    ...
    value: function changeIdentityOwner(_ref13) {
      var identityAddress = _ref13.identityAddress,
          newMainAddress = _ref13.newMainAddress,
          pin = _ref13.pin;
